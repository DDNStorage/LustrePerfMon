...
<definition>
 ...
 +snapshot_time: +.+
  ...
  quotactl: +\{ samples: +([[:digit:]]+).+</pattern>
						...
						FIELD(6, 6, getattr, number, ${key:hostname}, ${subpath:ost_name}, jobstat_${content:job_id}, derive, getattr, 1)
						FIELD(6, 7, setattr, number, ${key:hostname}, ${subpath:ost_name}, jobstat_${content:job_id}, derive, setattr, 1)
						FIELD(6, 8, punch, number, ${key:hostname}, ${subpath:ost_name}, jobstat_${content:job_id}, derive, pubch, 1)
						FIELD(6, 9, sync, number, ${key:hostname}, ${subpath:ost_name}, jobstat_${content:job_id}, derive, sync, 1)
						FIELD(6, 10, destroy, number, ${key:hostname}, ${subpath:ost_name}, jobstat_${content:job_id}, derive, destroy, 1)
						FIELD(6, 11, create, number, ${key:hostname}, ${subpath:ost_name}, jobstat_${content:job_id}, derive, create, 1)
						FIELD(6, 12, statfs, number, ${key:hostname}, ${subpath:ost_name}, jobstat_${content:job_id}, derive, statfs, 1)
						FIELD(6, 13, get_info, number, ${key:hostname}, ${subpath:ost_name}, jobstat_${content:job_id}, derive, get_info, 1)
						FIELD(6, 14, set_info, number, ${key:hostname}, ${subpath:ost_name}, jobstat_${content:job_id}, derive, set_info, 1)
						FIELD(6, 15, quotactl, number, ${key:hostname}, ${subpath:ost_name}, jobstat_${content:job_id}, derive, quotactl, 1)
					</item>
				</entry>
				<entry>
					<subpath>
